...
module CSSTE
  ...
  CSSTE_SCPU_0_0 U1
       (.Addr_out(SCPU_0_Addr_out),
        ...
        .clk(U8_Clk_CPU),
        .gp(U1_gp),
        .inst_in({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,U2_spo}),
        .ra(U1_ra),
        .rst(U9_rst),
        .s0(U1_s0),
        .s1(U1_s1),
  ...
  CSSTE_VGA_0_0 U11
       (.a0(U1_a0),
        ...
        .a6(U1_a6),
        .a7(U1_a7),
        .alu_res(SCPU_0_Addr_out),
        .clk_100m(clk_100mhz_1),
        .clk_25m(div1_Dout),
        .dmem_addr(SCPU_0_Addr_out),
        .dmem_i_data(U4_Cpu_data4bus),
        .dmem_o_data(RAM_B_0_douta),
        .gp(U1_gp),
        .hs(VGA_0_hs),
        .inst({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,U2_spo}),
        .mem_wen(SCPU_0_MemRW),
        .pc(SCPU_0_PC_out),
        .ra(U1_ra),
        .rst(U9_rst),
        .s0(U1_s0),
  ...
  CSSTE_Multi_8CH32_0_0 U5
       (.Data0(U4_Peripheral_in),
        ...
        .data2({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,U2_spo}),
        .data3(U10_counter_out),
        .data4(SCPU_0_Addr_out),
        .data5(SCPU_0_Data_out),
