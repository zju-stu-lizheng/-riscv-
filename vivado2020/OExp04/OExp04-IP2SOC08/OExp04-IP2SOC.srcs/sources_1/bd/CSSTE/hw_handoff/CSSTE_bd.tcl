...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_0 "BTN_OK[0]" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_1 "~clk_100mhz" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_10 "." [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_15 "." [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_16 "." [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_17 "{2'b0,PC[31:2]}" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_18 "inst[31:0]" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_19 "Counter_out[31:0]" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_20 "Addr_out[31:0]" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_21 "Data_out[31:0]" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_22 "Data_in[31:0]" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_23 "." [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_24 "." [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_3 "PC[11:2]" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_9 "sw[7:5]]" [get_bd_designs $design_name]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: BTN_Y0, and set properties
  set BTN_Y0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 BTN_Y0 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {0} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {4} \
  ...
  connect_bd_net -net BTN_Y0_Dout [get_bd_pins BTN_Y0/Dout] [get_bd_pins U8/STEP]
  connect_bd_net -net BTN_y_1 [get_bd_ports BTN_y] [get_bd_pins U9/Key_y]
  connect_bd_net -net Multi_8CH32_0_Disp_num [get_bd_pins U5/Disp_num] [get_bd_pins U6/Hexs]
  connect_bd_net -net Multi_8CH32_0_LE_out [get_bd_pins U5/LE_out] [get_bd_pins U6/LES]
  connect_bd_net -net Multi_8CH32_0_point_out [get_bd_pins U5/point_out] [get_bd_pins U6/point]
  ...
  connect_bd_net -net RAM_B_0_douta [get_bd_pins U11/dmem_o_data] [get_bd_pins U4/ram_data_out] [get_bd_pins dist_mem_gen_0/spo]
  connect_bd_net -net RSTN_1 [get_bd_ports RSTN] [get_bd_pins U9/RSTN]
  connect_bd_net -net SCPU_0_Addr_out [get_bd_pins U1/Addr_out] [get_bd_pins U11/alu_res] [get_bd_pins U11/dmem_addr] [get_bd_pins U4/addr_bus] [get_bd_pins U5/data4]
  connect_bd_net -net SCPU_0_Data_out [get_bd_pins U1/Data_out] [get_bd_pins U4/Cpu_data2bus] [get_bd_pins U5/data5]
  connect_bd_net -net SCPU_0_MemRW [get_bd_pins U1/MemRW] [get_bd_pins U11/mem_wen] [get_bd_pins U4/mem_w]
  connect_bd_net -net SCPU_0_PC_out [get_bd_pins PC11_2/Din] [get_bd_pins PC31_2/Din] [get_bd_pins U1/PC_out] [get_bd_pins U11/pc] [get_bd_pins U5/data7]
  connect_bd_net -net SW_1 [get_bd_ports SW] [get_bd_pins U9/SW]
  ...
  connect_bd_net -net U1_a0 [get_bd_pins U1/a0] [get_bd_pins U11/a0]
  connect_bd_net -net U1_a1 [get_bd_pins U1/a1] [get_bd_pins U11/a1]
  connect_bd_net -net U1_a2 [get_bd_pins U1/a2] [get_bd_pins U11/a2]
  connect_bd_net -net U1_a3 [get_bd_pins U1/a3] [get_bd_pins U11/a3]
  connect_bd_net -net U1_a4 [get_bd_pins U1/a4] [get_bd_pins U11/a4]
  connect_bd_net -net U1_a5 [get_bd_pins U1/a5] [get_bd_pins U11/a5]
  connect_bd_net -net U1_a6 [get_bd_pins U1/a6] [get_bd_pins U11/a6]
  connect_bd_net -net U1_a7 [get_bd_pins U1/a7] [get_bd_pins U11/a7]
  connect_bd_net -net U1_gp [get_bd_pins U1/gp] [get_bd_pins U11/gp]
  connect_bd_net -net U1_ra [get_bd_pins U1/ra] [get_bd_pins U11/ra]
  connect_bd_net -net U1_s0 [get_bd_pins U1/s0] [get_bd_pins U11/s0]
  connect_bd_net -net U1_s1 [get_bd_pins U1/s1] [get_bd_pins U11/s1]
  connect_bd_net -net U1_s2 [get_bd_pins U1/s2] [get_bd_pins U11/s2]
  connect_bd_net -net U1_s3 [get_bd_pins U1/s3] [get_bd_pins U11/s3]
  connect_bd_net -net U1_s4 [get_bd_pins U1/s4] [get_bd_pins U11/s4]
  connect_bd_net -net U1_s5 [get_bd_pins U1/s5] [get_bd_pins U11/s5]
  connect_bd_net -net U1_s6 [get_bd_pins U1/s6] [get_bd_pins U11/s6]
  connect_bd_net -net U1_s7 [get_bd_pins U1/s7] [get_bd_pins U11/s7]
  connect_bd_net -net U1_s8 [get_bd_pins U1/s8] [get_bd_pins U11/s8]
  connect_bd_net -net U1_s9 [get_bd_pins U1/s9] [get_bd_pins U11/s9]
  connect_bd_net -net U1_s10 [get_bd_pins U1/s10] [get_bd_pins U11/s10]
  connect_bd_net -net U1_s11 [get_bd_pins U1/s11] [get_bd_pins U11/s11]
  connect_bd_net -net U1_sp [get_bd_pins U1/sp] [get_bd_pins U11/sp]
  connect_bd_net -net U1_t0 [get_bd_pins U1/t0] [get_bd_pins U11/t0]
  connect_bd_net -net U1_t1 [get_bd_pins U1/t1] [get_bd_pins U11/t1]
  connect_bd_net -net U1_t2 [get_bd_pins U1/t2] [get_bd_pins U11/t2]
  connect_bd_net -net U1_t3 [get_bd_pins U1/t3] [get_bd_pins U11/t3]
  connect_bd_net -net U1_t4 [get_bd_pins U1/t4] [get_bd_pins U11/t4]
  connect_bd_net -net U1_t5 [get_bd_pins U1/t5] [get_bd_pins U11/t5]
  connect_bd_net -net U1_t6 [get_bd_pins U1/t6] [get_bd_pins U11/t6]
  connect_bd_net -net U1_tp [get_bd_pins U1/tp] [get_bd_pins U11/tp]
  connect_bd_net -net U1_x0 [get_bd_pins U1/x0] [get_bd_pins U11/x0]
  connect_bd_net -net U2_spo [get_bd_pins U1/inst_in] [get_bd_pins U11/inst] [get_bd_pins U2/spo] [get_bd_pins U5/data2]
  connect_bd_net -net U4_Cpu_data4bus [get_bd_pins U11/dmem_i_data] [get_bd_pins U4/ram_data_in] [get_bd_pins dist_mem_gen_0/d]
  connect_bd_net -net U4_Cpu_data4bus1 [get_bd_pins U1/Data_in] [get_bd_pins U4/Cpu_data4bus] [get_bd_pins U5/data6]
  ...
  connect_bd_net -net U4_data_ram_we [get_bd_pins U4/data_ram_we] [get_bd_pins dist_mem_gen_0/we]
  connect_bd_net -net U4_ram_addr [get_bd_pins U4/ram_addr] [get_bd_pins dist_mem_gen_0/a]
  ...
  connect_bd_net -net U9_BTN_OK [get_bd_pins BTN_Y0/Din] [get_bd_pins U4/BTN] [get_bd_pins U9/BTN_OK]
  ...
  connect_bd_net -net VGA_0_hs [get_bd_ports HSYNC] [get_bd_pins U11/hs]
  connect_bd_net -net VGA_0_vga_b [get_bd_ports Blue] [get_bd_pins U11/vga_b]
  connect_bd_net -net VGA_0_vga_g [get_bd_ports Green] [get_bd_pins U11/vga_g]
  connect_bd_net -net VGA_0_vga_r [get_bd_ports Red] [get_bd_pins U11/vga_r]
  connect_bd_net -net VGA_0_vs [get_bd_ports VSYNC] [get_bd_pins U11/vs]
  connect_bd_net -net b2_0_dout [get_bd_pins b2_0/dout] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net clk_100mhz_1 [get_bd_ports clk_100mhz] [get_bd_pins U11/clk_100m] [get_bd_pins U4/clk] [get_bd_pins U6/clk] [get_bd_pins U8/clk] [get_bd_pins U9/clk] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins dist_mem_gen_0/clk] [get_bd_pins util_vector_logic_1/Res]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins U5/data1] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins U5/LES] [get_bd_pins b64_0/dout]
