...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L dist_mem_gen_v8_0_13 -L xlconcat_v2_1_4 -L xlslice_v1_0_2 -L xlconstant_v1_1_7 -L util_vector_logic_v2_0_1 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot CSSTE xil_defaultlib.CSSTE xil_defaultlib.glbl -log elaborate.log
}
