...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.coefficient_file {../../../../../../COE/I_mem.coe} \
  ...
  connect_bd_net -net Pipeline_CPU_0_Addr_out [get_bd_pins Pipeline_CPU_0/Addr_out] [get_bd_pins U11/Addr_out] [get_bd_pins U4/addr_bus] [get_bd_pins U5/data4]
  connect_bd_net -net Pipeline_CPU_0_Data_out [get_bd_pins Pipeline_CPU_0/Data_out] [get_bd_pins U11/Data_out] [get_bd_pins U4/Cpu_data2bus] [get_bd_pins U5/data5]
  connect_bd_net -net Pipeline_CPU_0_Data_out_WB [get_bd_pins Pipeline_CPU_0/Data_out_WB] [get_bd_pins U11/Data_out_WB]
  connect_bd_net -net Pipeline_CPU_0_MemRW_EX [get_bd_pins Pipeline_CPU_0/MemRW_EX] [get_bd_pins U11/MemRW_Ex]
  connect_bd_net -net Pipeline_CPU_0_MemRW_Mem [get_bd_pins Pipeline_CPU_0/MemRW_Mem] [get_bd_pins U11/MemRW_Mem] [get_bd_pins U4/mem_w]
  connect_bd_net -net Pipeline_CPU_0_PC_out_EX [get_bd_pins Pipeline_CPU_0/PC_out_EX] [get_bd_pins U11/PC_Ex]
  connect_bd_net -net Pipeline_CPU_0_PC_out_ID [get_bd_pins Pipeline_CPU_0/PC_out_ID] [get_bd_pins U11/PC_ID]
  connect_bd_net -net Pipeline_CPU_0_PC_out_IF [get_bd_pins PC11_2/Din] [get_bd_pins PC31_2/Din] [get_bd_pins Pipeline_CPU_0/PC_out_IF] [get_bd_pins U11/PC_IF] [get_bd_pins U5/data7]
  connect_bd_net -net Pipeline_CPU_0_inst_ID [get_bd_pins Pipeline_CPU_0/inst_ID] [get_bd_pins U11/inst_ID]
  connect_bd_net -net RAM_B_0_douta [get_bd_pins U4/ram_data_out] [get_bd_pins dist_mem_gen_0/spo]
  ...
  connect_bd_net -net U2_spo [get_bd_pins Pipeline_CPU_0/inst_IF] [get_bd_pins U11/inst_IF] [get_bd_pins U2/spo] [get_bd_pins U5/data2]
  connect_bd_net -net U4_Cpu_data4bus [get_bd_pins U4/ram_data_in] [get_bd_pins dist_mem_gen_0/d]
  connect_bd_net -net U4_Cpu_data4bus1 [get_bd_pins Pipeline_CPU_0/Data_in] [get_bd_pins U4/Cpu_data4bus] [get_bd_pins U5/data6]
  ...
  connect_bd_net -net U8_Clk_CPU [get_bd_pins Pipeline_CPU_0/clk] [get_bd_pins U8/Clk_CPU] [get_bd_pins util_vector_logic_0/Op1]
  ...
  connect_bd_net -net U9_BTN_OK [get_bd_pins U4/BTN] [get_bd_pins U9/BTN_OK]
  connect_bd_net -net U9_SW_OK [get_bd_pins U4/SW] [get_bd_pins U9/SW_OK] [get_bd_pins sw0/Din] [get_bd_pins sw2/Din] [get_bd_pins sw7_5/Din] [get_bd_pins sw8/Din] [get_bd_pins sw9/Din]
  connect_bd_net -net U9_rst [get_bd_pins Pipeline_CPU_0/rst] [get_bd_pins U10/rst] [get_bd_pins U11/rst] [get_bd_pins U4/rst] [get_bd_pins U5/rst] [get_bd_pins U6/rst] [get_bd_pins U7/rst] [get_bd_pins U8/rst] [get_bd_pins U9/rst]
  ...
  connect_bd_net -net sw9_Dout1 [get_bd_pins U8/STEP] [get_bd_pins sw9/Dout]
