...
HD_PWD='C:/Users/ASUS/Desktop/OExp_RISCV/OExp02/IP/Supplementary/Counter_x/Counter_x.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter_x.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Counter_x.tcl
