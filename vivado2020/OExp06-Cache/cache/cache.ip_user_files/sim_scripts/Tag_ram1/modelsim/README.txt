...
#
# Generated by export_simulation on Mon Jun 14 17:25:27 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './Tag_ram1.sh' script.

./Tag_ram1.sh -reset_run
...
./Tag_ram1.sh -noclean_files

For more information on the script, please type './Tag_ram1.sh -help'.
