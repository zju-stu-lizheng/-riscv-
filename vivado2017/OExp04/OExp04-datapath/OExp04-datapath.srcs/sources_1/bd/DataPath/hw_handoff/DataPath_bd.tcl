...
proc create_root_design { parentCell } {
  ...
  # Create instance: ALU_wrapper_0, and set properties
  set ALU_wrapper_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ALU_wrapper:1.0 ALU_wrapper_0 ]
  ...
  connect_bd_net -net ALU_operation_0_1 [get_bd_ports ALU_operation] [get_bd_pins ALU_wrapper_0/ALU_operation]
  connect_bd_net -net ALU_wrapper_0_res [get_bd_ports ALU_out] [get_bd_pins ALU_wrapper_0/res] [get_bd_pins MUX4T1_32_0/I0]
  connect_bd_net -net ALU_wrapper_0_zero [get_bd_pins ALU_wrapper_0/zero] [get_bd_pins and_2/Op2]
  connect_bd_net -net I1_0_1 [get_bd_ports Data_in] [get_bd_pins MUX4T1_32_0/I1]
  connect_bd_net -net ImmGen_0_Imm_out [get_bd_pins ImmGen_0/Imm_out] [get_bd_pins MUX2T1_32_2/I1] [get_bd_pins add_32_0/b]
  connect_bd_net -net ImmSel_0_1 [get_bd_ports ImmSel] [get_bd_pins ImmGen_0/ImmSel]
  connect_bd_net -net MUX2T1_32_0_o [get_bd_pins MUX2T1_32_0/o] [get_bd_pins MUX2T1_32_1/I0]
  connect_bd_net -net MUX2T1_32_1_o [get_bd_pins MUX2T1_32_1/o] [get_bd_pins PC/D]
  connect_bd_net -net MUX2T1_32_2_o [get_bd_pins ALU_wrapper_0/B] [get_bd_pins MUX2T1_32_2/o]
  ...
  connect_bd_net -net PC4_dout [get_bd_pins PC4/dout] [get_bd_pins add_32_1/b]
  ...
  connect_bd_net -net add_32_0_c [get_bd_pins MUX2T1_32_0/I1] [get_bd_pins MUX2T1_32_1/I1] [get_bd_pins add_32_0/c]
  connect_bd_net -net add_32_1_c [get_bd_pins MUX2T1_32_0/I0] [get_bd_pins MUX4T1_32_0/I2] [get_bd_pins MUX4T1_32_0/I3] [get_bd_pins add_32_1/c]
  connect_bd_net -net and_2_Res [get_bd_pins MUX2T1_32_0/s] [get_bd_pins and_2/Res]
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins PC/clk] [get_bd_pins regs_0/clk]
  connect_bd_net -net inst11_7_Dout [get_bd_pins inst11_7/Dout] [get_bd_pins regs_0/Wt_addr]
  connect_bd_net -net inst19_15_Dout [get_bd_pins inst19_15/Dout] [get_bd_pins regs_0/Rs1_addr]
  connect_bd_net -net inst24_20_Dout [get_bd_pins inst24_20/Dout] [get_bd_pins regs_0/Rs2_addr]
  ...
  connect_bd_net -net regs_0_Rs1_data [get_bd_pins ALU_wrapper_0/A] [get_bd_pins regs_0/Rs1_data]
  connect_bd_net -net regs_0_Rs2_data [get_bd_ports Data_out] [get_bd_pins MUX2T1_32_2/I0] [get_bd_pins regs_0/Rs2_data]
  ...
  connect_bd_net -net s_0_1 [get_bd_ports Jump] [get_bd_pins MUX2T1_32_1/s]
  connect_bd_net -net s_0_2 [get_bd_ports MemtoReg] [get_bd_pins MUX4T1_32_0/s]
  connect_bd_net -net s_0_3 [get_bd_ports ALUSrc_B] [get_bd_pins MUX2T1_32_2/s]
