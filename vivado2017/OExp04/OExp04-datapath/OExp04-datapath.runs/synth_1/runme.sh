...
HD_PWD='D:/ISE/vivado/OExp04/OExp04-datapath/OExp04-datapath.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DataPath_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DataPath_wrapper.tcl
