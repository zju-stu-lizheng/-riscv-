...
proc create_root_design { parentCell } {
  ...
  # Create instance: IP2CPU_0, and set properties
  set IP2CPU_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:IP2CPU:1.0 IP2CPU_0 ]
  ...
  set_property -dict [ list \
   CONFIG.coefficient_file {../../../../../../I_mem00.coe} \
  ...
  connect_bd_net -net BTN_OK0_Dout [get_bd_pins U8/STEP] [get_bd_pins sw9/Dout]
  ...
  connect_bd_net -net IP2CPU_0_a0 [get_bd_pins IP2CPU_0/a0] [get_bd_pins U11/a0]
  connect_bd_net -net IP2CPU_0_a1 [get_bd_pins IP2CPU_0/a1] [get_bd_pins U11/a1]
  connect_bd_net -net IP2CPU_0_a2 [get_bd_pins IP2CPU_0/a2] [get_bd_pins U11/a2]
  connect_bd_net -net IP2CPU_0_a3 [get_bd_pins IP2CPU_0/a3] [get_bd_pins U11/a3]
  connect_bd_net -net IP2CPU_0_a4 [get_bd_pins IP2CPU_0/a4] [get_bd_pins U11/a4]
  connect_bd_net -net IP2CPU_0_a5 [get_bd_pins IP2CPU_0/a5] [get_bd_pins U11/a5]
  connect_bd_net -net IP2CPU_0_a6 [get_bd_pins IP2CPU_0/a6] [get_bd_pins U11/a6]
  connect_bd_net -net IP2CPU_0_a7 [get_bd_pins IP2CPU_0/a7] [get_bd_pins U11/a7]
  connect_bd_net -net IP2CPU_0_gp [get_bd_pins IP2CPU_0/gp] [get_bd_pins U11/gp]
  connect_bd_net -net IP2CPU_0_ra [get_bd_pins IP2CPU_0/ra] [get_bd_pins U11/ra]
  connect_bd_net -net IP2CPU_0_s0 [get_bd_pins IP2CPU_0/s0] [get_bd_pins U11/s0]
  connect_bd_net -net IP2CPU_0_s1 [get_bd_pins IP2CPU_0/s1] [get_bd_pins U11/s1]
  connect_bd_net -net IP2CPU_0_s2 [get_bd_pins IP2CPU_0/s2] [get_bd_pins U11/s2]
  connect_bd_net -net IP2CPU_0_s3 [get_bd_pins IP2CPU_0/s3] [get_bd_pins U11/s3]
  connect_bd_net -net IP2CPU_0_s4 [get_bd_pins IP2CPU_0/s4] [get_bd_pins U11/s4]
  connect_bd_net -net IP2CPU_0_s5 [get_bd_pins IP2CPU_0/s5] [get_bd_pins U11/s5]
  connect_bd_net -net IP2CPU_0_s6 [get_bd_pins IP2CPU_0/s6] [get_bd_pins U11/s6]
  connect_bd_net -net IP2CPU_0_s7 [get_bd_pins IP2CPU_0/s7] [get_bd_pins U11/s7]
  connect_bd_net -net IP2CPU_0_s8 [get_bd_pins IP2CPU_0/s8] [get_bd_pins U11/s8]
  connect_bd_net -net IP2CPU_0_s9 [get_bd_pins IP2CPU_0/s9] [get_bd_pins U11/s9]
  connect_bd_net -net IP2CPU_0_s10 [get_bd_pins IP2CPU_0/s10] [get_bd_pins U11/s10]
  connect_bd_net -net IP2CPU_0_s11 [get_bd_pins IP2CPU_0/s11] [get_bd_pins U11/s11]
  connect_bd_net -net IP2CPU_0_sp [get_bd_pins IP2CPU_0/sp] [get_bd_pins U11/sp]
  connect_bd_net -net IP2CPU_0_t0 [get_bd_pins IP2CPU_0/t0] [get_bd_pins U11/t0]
  connect_bd_net -net IP2CPU_0_t1 [get_bd_pins IP2CPU_0/t1] [get_bd_pins U11/t1]
  connect_bd_net -net IP2CPU_0_t2 [get_bd_pins IP2CPU_0/t2] [get_bd_pins U11/t2]
  connect_bd_net -net IP2CPU_0_t3 [get_bd_pins IP2CPU_0/t3] [get_bd_pins U11/t3]
  connect_bd_net -net IP2CPU_0_t4 [get_bd_pins IP2CPU_0/t4] [get_bd_pins U11/t4]
  connect_bd_net -net IP2CPU_0_t5 [get_bd_pins IP2CPU_0/t5] [get_bd_pins U11/t5]
  connect_bd_net -net IP2CPU_0_t6 [get_bd_pins IP2CPU_0/t6] [get_bd_pins U11/t6]
  connect_bd_net -net IP2CPU_0_tp [get_bd_pins IP2CPU_0/tp] [get_bd_pins U11/tp]
  connect_bd_net -net IP2CPU_0_x0 [get_bd_pins IP2CPU_0/x0] [get_bd_pins U11/x0]
  ...
  connect_bd_net -net Net1 [get_bd_pins U4/Cpu_data4bus] [get_bd_pins U5/data6]
  ...
  connect_bd_net -net SAnti_jitter_0_SW_OK [get_bd_pins U4/SW] [get_bd_pins U9/SW_OK] [get_bd_pins sw0/Din] [get_bd_pins sw2/Din] [get_bd_pins sw7_5/Din] [get_bd_pins sw8/Din] [get_bd_pins sw9/Din]
  ...
  connect_bd_net -net U1_Addr_out [get_bd_pins IP2CPU_0/Addr_out] [get_bd_pins U11/alu_res] [get_bd_pins U11/dmem_addr] [get_bd_pins U4/addr_bus] [get_bd_pins U5/data4]
  connect_bd_net -net U1_Data_out [get_bd_pins IP2CPU_0/Data_out] [get_bd_pins U4/Cpu_data2bus] [get_bd_pins U5/data5]
  connect_bd_net -net U1_MemRW [get_bd_pins IP2CPU_0/MemRW] [get_bd_pins U11/mem_wen] [get_bd_pins U4/mem_w]
  connect_bd_net -net U1_PC_out [get_bd_pins IP2CPU_0/PC_out] [get_bd_pins PC11_2/Din] [get_bd_pins PC31_2/Din] [get_bd_pins U11/pc] [get_bd_pins U5/data7]
  connect_bd_net -net U2_spo [get_bd_pins IP2CPU_0/inst_in] [get_bd_pins U11/inst] [get_bd_pins U2/spo] [get_bd_pins U5/data2]
  connect_bd_net -net U3_douta [get_bd_pins IP2CPU_0/Data_in] [get_bd_pins U11/dmem_o_data] [get_bd_pins U3/spo] [get_bd_pins U4/ram_data_out]
  ...
  connect_bd_net -net U8_Clk_CPU [get_bd_pins IP2CPU_0/clk] [get_bd_pins U8/Clk_CPU] [get_bd_pins util_vector_logic_0/Op1]
  ...
  connect_bd_net -net U9_rst [get_bd_pins IP2CPU_0/rst] [get_bd_pins U10/rst] [get_bd_pins U11/rst] [get_bd_pins U4/rst] [get_bd_pins U5/rst] [get_bd_pins U6/rst] [get_bd_pins U7/rst] [get_bd_pins U8/rst] [get_bd_pins U9/rst]
