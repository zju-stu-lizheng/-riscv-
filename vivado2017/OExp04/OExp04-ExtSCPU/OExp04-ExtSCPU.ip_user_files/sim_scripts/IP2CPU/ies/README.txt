...
#
# Generated by export_simulation on Sat May 15 22:20:35 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './IP2CPU.sh' script.
...
./IP2CPU.sh -noclean_files

For more information on the script, please type './IP2CPU.sh -help'.
