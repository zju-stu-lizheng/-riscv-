...
proc create_root_design { parentCell } {
  ...
  # Create instance: ADC32_0, and set properties
  set ADC32_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ADC32:1.0 ADC32_0 ]
  ...
  connect_bd_net -net ADC32_0_S [get_bd_pins ADC32_0/S] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  connect_bd_net -net ALU_operation_1 [get_bd_ports ALU_operation] [get_bd_pins MUX8T1_32_0/s] [get_bd_pins xlslice_2/Din]
  connect_bd_net -net A_1 [get_bd_ports A] [get_bd_pins ADC32_0/A] [get_bd_pins and32_0/A] [get_bd_pins nor32_0/A] [get_bd_pins or32_0/A] [get_bd_pins srl32_0/A] [get_bd_pins xor32_0/A]
  ...
  connect_bd_net -net xlslice_2_Dout [get_bd_pins ADC32_0/C0] [get_bd_pins SignalExt_32_0/S] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xor32_0_res [get_bd_pins MUX8T1_32_0/I3] [get_bd_pins xor32_0/res]
  connect_bd_net -net xor32_1_res [get_bd_pins ADC32_0/B] [get_bd_pins xor32_1/res]
